...
_CRYPTO_ALIASES = {
    ...
    "USDC": "usd-coin", "SHIB": "shiba-inu", "NEAR": "near",
    "OP": "optimism", "ARB": "arbitrum", "PEPE": "pepe",
}


# Pickable lists shown in the UI symbol picker.
SYMBOL_CATALOG = {
    "crypto": [
        ("BTC", "Bitcoin"),
        ("ETH", "Ethereum"),
    ...
    "currency": [
        ("USD-TRY", "Dolar / Türk Lirası"),
        ("EUR-TRY", "Euro / Türk Lirası"),
        ("GBP-TRY", "Sterlin / Türk Lirası"),
        ...
        ("USD-CHF", "Dolar / Frank"),
        ("USD-CAD", "Dolar / Kanada Doları"),
        ("AUD-USD", "Avustralya Doları / Dolar"),
        ("NZD-USD", "Yeni Zelanda Doları / Dolar"),
        ("USD-CNY", "Dolar / Yuan"),
        ("USD-INR", "Dolar / Rupi"),
        ("USD-RUB", "Dolar / Ruble"),
    ],
